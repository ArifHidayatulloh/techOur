                        ...
                        <div class="ms-3 fw-bold">
                            ...
                            <ol class="list-group">
                                <li class="list-group-item border-0 d-flex justify-content-between align-items-start">
                                    <div class="me-auto">
                                        <div class="fw-bold">ShopeePay 081211903974 / username noisestudio</div>
                                    </div>
                                    <div class="d-flex">
                                        <a class="btn" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal3"><i class='bx bxs-edit-alt'
                                                style="color: black; font-size: 23px"></i></a>

                                        <div class="delete">
                                            <button type="submit" class="btn">
                                                <i class="bx bxs-trash-alt" style="color: black; font-size: 23px"></i>
                                            </button>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <li class="list-group-item border-0 d-flex justify-content-between align-items-start">
                                    <div class="me-auto">
                                        <div class="fw-bold">Dana 081211903974 / username noisestudio</div>
                                    </div>
                                    <div class="d-flex">
                                        <a class="btn" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal3"><i class='bx bxs-edit-alt'
